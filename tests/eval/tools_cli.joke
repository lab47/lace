(ns lace.test-clojure.tools-cli
  (:require [lace.tools.cli :as cli :refer [get-default-options parse-opts summarize]]
            [lace.string :refer [join]]
