...
func InternsOrThunks(env *Env, ns *Namespace) {
	...
	ns.InternVar(env, "list-separator", list_separator_,
		MakeMeta(
			nil,
			`OS-specific path list separator.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))

	ns.InternVar(env, "separator", separator_,
		MakeMeta(
			nil,
			`OS-specific path separator.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  Calls clean on the result.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))

	ns.InternVar(env, "abs?", isabs_,
		MakeMeta(
			NewListFrom(NewVectorFrom(MakeSymbol("path"))),
			`Reports whether the path is absolute.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "Boolean"}))
  ...
  entirely of separators, returns a single separator.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
...
If the result of this process is an empty string, returns the string ".".`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  returns a single separator. The returned path does not end in a separator unless it is the root directory.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  in the final element of path; it is empty if there is no dot.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  Multiple slashes are replaced by multiple separators.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  Throws exception when pattern is malformed.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "[String]"}))
  ...
  the result is a UNC path if and only if the first path element is a UNC path.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  On Windows, escaping is disabled. Instead, '\' is treated as path separator.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "Boolean"}))
  ...
  Returns an empty slice when passed an empty string.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "[String]"}))
  ...
  Multiple separators are replaced by multiple slashes.`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
  ...
  returns "\\host\share". On other platforms it returns "".`, "1.0").Plus(env, MakeKeyword("tag"), String{S: "String"}))
