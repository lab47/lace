...
func __atoi_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
...
func __iscan_backquote_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __format_bool_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
...
func __format_double_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 4:
...
func __format_int_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 2:
...
func __isgraphic_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
...
func __itoa_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		i := ExtractInt(_args, 0)
...
func __parse_bool_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __parse_double_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __parse_int_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 3:
		s := ExtractString(_args, 0)
...
func __isprintable_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		c := ExtractChar(_args, 0)
...
func __quote_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __quote_char_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		c := ExtractChar(_args, 0)
...
func __quote_char_to_ascii_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		c := ExtractChar(_args, 0)
...
func __quote_char_to_graphic_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		c := ExtractChar(_args, 0)
...
func __quote_to_ascii_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __quote_to_graphic_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
...
func __unquote_(_env *Env, _args []Object) Object {
	_c := len(_args)
	switch {
	case _c == 1:
		s := ExtractString(_args, 0)
