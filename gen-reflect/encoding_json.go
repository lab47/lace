...
func init() {
	...
	pkgreflect.AddPackage("encoding/json", &pkgreflect.Package{
		...
		Types: map[string]pkgreflect.Type{
			"Decoder":               {Doc: "", Value: reflect.TypeOf((*p.Decoder)(nil)).Elem(), Methods: Decoder_methods},
			"Delim":                 {Doc: "", Value: reflect.TypeOf((*p.Delim)(nil)).Elem(), Methods: Delim_methods},
			"Encoder":               {Doc: "", Value: reflect.TypeOf((*p.Encoder)(nil)).Elem(), Methods: Encoder_methods},
			"InvalidUTF8Error":      {Doc: "", Value: reflect.TypeOf((*p.InvalidUTF8Error)(nil)).Elem(), Methods: InvalidUTF8Error_methods},
			"InvalidUnmarshalError": {Doc: "", Value: reflect.TypeOf((*p.InvalidUnmarshalError)(nil)).Elem(), Methods: InvalidUnmarshalError_methods},
			"Marshaler":             {Doc: "", Value: reflect.TypeOf((*p.Marshaler)(nil)).Elem(), Methods: Marshaler_methods},
			"MarshalerError":        {Doc: "", Value: reflect.TypeOf((*p.MarshalerError)(nil)).Elem(), Methods: MarshalerError_methods},
			"Number":                {Doc: "", Value: reflect.TypeOf((*p.Number)(nil)).Elem(), Methods: Number_methods},
			"RawMessage":            {Doc: "", Value: reflect.TypeOf((*p.RawMessage)(nil)).Elem(), Methods: RawMessage_methods},
			"SyntaxError":           {Doc: "", Value: reflect.TypeOf((*p.SyntaxError)(nil)).Elem(), Methods: SyntaxError_methods},
			"Token":                 {Doc: "", Value: reflect.TypeOf((*p.Token)(nil)).Elem(), Methods: Token_methods},
			"UnmarshalFieldError":   {Doc: "", Value: reflect.TypeOf((*p.UnmarshalFieldError)(nil)).Elem(), Methods: UnmarshalFieldError_methods},
			"UnmarshalTypeError":    {Doc: "", Value: reflect.TypeOf((*p.UnmarshalTypeError)(nil)).Elem(), Methods: UnmarshalTypeError_methods},
			"Unmarshaler":           {Doc: "", Value: reflect.TypeOf((*p.Unmarshaler)(nil)).Elem(), Methods: Unmarshaler_methods},
			"UnsupportedTypeError":  {Doc: "", Value: reflect.TypeOf((*p.UnsupportedTypeError)(nil)).Elem(), Methods: UnsupportedTypeError_methods},
			"UnsupportedValueError": {Doc: "", Value: reflect.TypeOf((*p.UnsupportedValueError)(nil)).Elem(), Methods: UnsupportedValueError_methods},
