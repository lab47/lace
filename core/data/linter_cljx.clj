(defn ^:private conj-import*
  [v sym]
  (let [parts (lace.string/split (name sym) #"\.")]
...
(defmacro import
  ...
  (let [specs (map #(if (and (seq? %) (= 'quote (first %))) (second %) %)
        ...
        syms (reduce (fn [v spec]
                     ...
                     [] specs)]
    `(do nil nil
       ~@(map #(list 'lace.core/require (list 'quote %)) syms)
...
(def default-data-readers
  (apply merge
   {'inst #'lace.core/identity
    'uuid #'lace.core/identity}
   (map (fn [sym] {sym #'lace.core/taggify__}) (:known-tags lace.core/*linter-config*))))
...
(doseq [sym (:known-namespaces lace.core/*linter-config*)]
  (inject-ns__ sym))
...
(defn vec ^Vector [^Seqable coll] (vec__ coll))
...
(ns-unmap 'lace.core 'bigfloat?)
(ns-unmap 'user 'bigfloat?)
(ns-unmap 'lace.core 'bigfloat)
(ns-unmap 'user 'bigfloat)
(ns-unmap 'lace.core 'lace-version)
(ns-unmap 'user 'lace-version)
(ns-unmap 'lace.core 'pprint)
(ns-unmap 'user 'pprint)
(ns-unmap 'lace.core 'pr-err)
(ns-unmap 'user 'pr-err)
(ns-unmap 'lace.core 'prn-err)
(ns-unmap 'user 'prn-err)
(ns-unmap 'lace.core 'print-err)
(ns-unmap 'user 'print-err)
(ns-unmap 'lace.core 'println-err)
(ns-unmap 'user 'println-err)
(ns-unmap 'lace.core 'ns-sources)
(ns-unmap 'user 'ns-sources)
(ns-unmap 'lace.core '*main-file*)
(ns-unmap 'lace.core 'go)
(ns-unmap 'user 'go)
(ns-unmap 'lace.core '<!)
(ns-unmap 'user '<!)
(ns-unmap 'lace.core '>!)
(ns-unmap 'user '>!)
(ns-unmap 'lace.core 'close!)
(ns-unmap 'user 'close!)
(ns-unmap 'lace.core 'chan)
(ns-unmap 'user 'chan)
