...
{lib-code}func init() {
{set-lazy}
	buildConstructors = append(buildConstructors, {name}Construct)
}

func {name}Construct(env *Env) error {
	return processInEnv(env, {name}Data)
}
...
var buildConstructors []func(env *Env) error
